    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <form action={formAction} className="space-y-4">
          ...
          <button disabled={isPending} className="w-full rounded-md bg-black py-2 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-300">
